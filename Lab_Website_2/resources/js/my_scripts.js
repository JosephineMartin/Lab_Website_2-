...
*/
	...
	function viewStudentStats(id, toggle){
		var status = document.getElementById(id);//retrieve the current status
		if (toggle == 1)
		{
...
function loadStatsPage(){
		...
		var tableWin = document.getElementById('wins').innerHTML;
		var tableLoss = document.getElementById('losses').innerHTML;
		...
		{//Outer for loop iterates over each row
				...
				cell_value_2 = table.rows[row_counter].cells[2].innerHTML;
				cell_value_3 = table.rows[row_counter].cells[3].innerHTML;
		...
		document.getElementById('wins').innerHTML = tableWin;
		document.getElementById('losses').innerHTML = tableLoss;
...
*/
	...
	function loadPlayersPage(){
		...
		{
			//make a drop down menu option and then add the menu option

			var option = document.createElement("A"); //setting type A==link option == button?
			option.href = "#";
			...
			option.setAttribute("onclick","switchPlayers(this.name)");


			document.getElementById("player_selector").append(option);
		}
...
//document.getElementById('player_img').src = "https://pixels.com/featured/american-football-running-back-ball-cartoon-aloysius-patrimonio.html";
//document.getElementById('player_img').href = "#";
